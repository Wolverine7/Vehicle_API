...
//Middleware
//Middleware can be very useful for doing validation. We codealong
//log from here or stop the request in the event
//that the request is not safe
//middleware to use for all request
// router.use(function(req, response, next){
//
//   console.log('FYI...There is some processing going on..');
//   //move on the route
//   next();
//
// });

//list the ports. Environments ports
